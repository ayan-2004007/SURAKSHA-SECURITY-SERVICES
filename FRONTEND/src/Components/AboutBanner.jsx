        ...
        <div className="lg:flex lg:flex-row-reverse md:flex-col mb-44 md:mb-[280px] lg:-mb-[120px] 2xl:-mb-[320px]">
            ...
            <div className='2xl:px-20 flex flex-col w-full max-h-[750px] item-center justify-center gap-7 xl:px-0 xl:pl-10 lg:pl-7 lg:text-start md:text-center px-5'>
                ...
                <div className='flex flex-row gap-3 md:gap-6 lg:mx-0 md:mx-auto'>
                    <button className={`font-["Montserrat"] font-bold text-xs px-5 py-4 sm:text-[13px] md:text-base md:px-7 md:py-5 lg:text-[13px] lg:px-5 lg:py-4 xl:text-base xl:px-9 bg-gradient-to-r from-[#AD1DEB] to-[#6E72FC] text-white ${fade ? 'opacity-0' : 'opacity-100'}`}>JOIN US NOW</button>
                    <button className={`font-["Montserrat"] text-xs font-bold px-5 py-4 sm:text-[13px] md:text-base md:px-7 md:py-5 lg:text-[13px] lg:px-5 lg:py-4 xl:text-base xl:px-9 border-2 border-[#AD1DEB] ${fade ? 'opacity-0' : 'opacity-100'}`}>CONTACT US</button>
                </div>
            </div>
        </div>
    );
