...
const CareerJoin = () => {
    return (
        <>
            <div className="lg:flex lg:flex-row md:flex-col mb-[120px] lg:-mb-[120px] 2xl:-mb-[300px]">
                ...
                <div className='2xl:px-20 flex flex-col w-full max-h-[580px] xl:max-h-[700px] item-center justify-center gap-7 xl:px-0 xl:pl-10 lg:pl-7 lg:text-start md:text-center px-5'>
                    ...
                    <div className='flex flex-row gap-3 md:gap-6 lg:mx-0 md:mx-auto '>
                        ...
                        <button className='font-["Montserrat"] text-xs font-bold px-5 py-4 sm:text-[13px] md:text-base md:px-7 md:py-5 lg:text-[13px] lg:px-5 lg:py-4 xl:text-base xl:px-9 border-2 border-[#AD1DEB] transition-all duration-150 ease-in hover:bg-[#131313] hover:text-white'>CONTACT US</button>
                    </div>
                </div>
            </div>
        </>
