...
const HomeBanner=()=> {
  ...
  return (
    <div className='mt-[170px] w-screen h-auto flex flex-col p-5 items-center pb-0 mx-auto gap-5 sm:gap-10 md:gap-12 lg:flex-row-reverse lg:gap-10 lg:pt-16 lg:max-w-[1138px] xl:pl-8 xl:max-w-[1338px] 2xl:max-w-[1680px] 2xl:gap-6 2xl:pt-24 2xl:pl-14 2xl:pr-0'>
      <img
        src={img}
        alt=""
