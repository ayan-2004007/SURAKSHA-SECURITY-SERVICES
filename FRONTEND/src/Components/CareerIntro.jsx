    ...
    return (
        <>
            <div className='w-full h-full bg-[#131313] pt-12 pb-16 px-3 md:px-5'>
                ...
                <div className='grid grid-cols-2 gap-x-4 sm:gap-x-8 xl:gap-x-0 gap-y-10 place-items-center text-[13px] md:text-sm lg:text-base sm:flex flex-wrap items-center justify-center xl:justify-between max-w-[1350px] mx-auto text-[#B1B1B1] text-center font-["otomanopee-one"]' data-aos="fade" data-aos-anchor-placement="center-bottom" data-aos-easing="ease-in-sine" data-aos-duration="500">
