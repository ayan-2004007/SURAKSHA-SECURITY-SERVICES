    ...
    return (
        <>
            <div className="w-ful bg-[#131313] flex items-center mt-[84px]">
                <div className="mx-auto flex flex-col items-center gap-12 py-10 2xl:pr-2 md:py-16 xl:gap-20 2xl:flex-row">
