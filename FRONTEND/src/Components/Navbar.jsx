    ...
    return (
        <>
            ...
            <div className='lg:flex justify-between items-center lg:px-[85px] py-3 lg:py-4 space-y-4 lg:space-y-0 text-center w-full bg-gradient-to-r from-[#3E187A] to-[#994ECC] text-white'>
                <div>
                    <p className='font-["Red Hat Display"] lg:tracking-widest text-xs lg:text-sm xl:text-base'><span className='font-["otomanopee-one"]'>CONTACT US ON : </span> +91 67496 21943 &nbsp;+91 67496 21943</p>
                </div>
                <div>
                    <p className='font-["Red Hat Display"] tracking-widest text-xs lg:text-sm xl:text-base'><span className='font-["otomanopee-one"]'>MAIL US ON : </span> &nbsp;surakshasecurity@gmail.com</p>
                </div>
            </div>

            {/* Navbar */}
            <div className='sticky top-0 flex justify-between items-center px-5 py-1 lg:hidden z-50 backdrop-blur-lg'>
                <div className='logo flex items-center space-x-2'>
                    ...
                    <div className='space-y-0.5'>
                        ...
                        <p className='font-["Red Hat Display"] text-[11px] font-semibold'>Trusted Security Solutions</p>
                    </div>
                </div>
            ...
            <div className='sticky top-0 px-6 xl:px-20 z-50 backdrop-blur-lg'>
                <div className='hidden lg:flex justify-between items-center w-full px-14 py-1 bg-opacity-[38%] rounded-[10px]'>
                    <div className='flex items-center gap-2'>
                        <img src={logo} alt="logo" className='hidden lg:block lg:w-[48px] lg:h-[56px] xl:w-[58px] xl:h-[66px]' />
                        <div>
                    ...
                    <div className='items flex items-center gap-72'>
                        <div className='hidden lg:flex'>
                            <ul className='hidden lg:flex font-["Philosopher"] text-[15px] font-extrabold space-x-5 xl:space-x-10 items-center cursor-pointer'>
                                <li>HOME</li>
                                <li>ABOUT</li>
                                <li>SERVICS</li>
                                <li>CAREERS</li>
