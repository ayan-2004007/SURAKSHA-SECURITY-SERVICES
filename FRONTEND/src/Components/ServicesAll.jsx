    ...
    return (
        <>
            <div className='md:max-w-[850px] lg:max-w-[1140px] xl:max-w-[1180px] 2xl:max-w-[1350px] mx-auto space-y-9 drop-shadow-[10px_10px_10px_rgba(0,0,0,0.25)]'>
                <div className='flex flex-col lg:flex-row items-center justify-between rounded-[10px] bg-white pt-7 lg:pt-1 px-3 md:px-7 py-1 mx-4 sm:mx-10 2xl:justify-around 2xl:py-8'>
                ...
                <div className='flex flex-col-reverse lg:flex-row items-center justify-between rounded-[10px] bg-white pt-7 lg:pt-1 px-3 md:px-7 py-1 mx-4 sm:mx-10 2xl:justify-around 2xl:py-8'>
                    <div className='lg:max-w-[470px] xl:max-w-[510px] space-y-7 py-7'>
